"""Background loop: records short clips, detects silence, and calls AudD."""
...
from vinyl_recognizer import audd, recorder
...
class RecognizerService:
    ...
    def tick(self) -> None:
        ...
        result = audd.recognize(recorder.to_wav_bytes(clip, self.config.sample_rate), self.config.audd_api_key)
