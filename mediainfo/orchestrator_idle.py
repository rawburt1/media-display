...
`random.uniform` for building rotation state live in `_ArtworkPipeline`
(orchestrator_artwork.py) and are reused here via the `build_rotation_states`
callback passed in, rather than duplicated.
