...
_FIELD_HELP_OVERRIDES: Dict[str, str] = {
    ...
    "themes.media_mosaic.corner": "Where the mosaic appears on screen.",
    "themes.media_mosaic.size_vw": "Max width as a percentage of screen width.",
    "themes.media_mosaic.max_tiles": "Cap on how many tiles to include - only artwork already available for the current item (other albums, posters, fanart) is used, never fetched specially.",
    "themes.lyrics_ticker.position": "Which screen edge the ticker runs along.",
    "themes.lyrics_ticker.show_next_line": "Show the upcoming line, faded, below the current one.",
    "themes.progress_bar.position": "Which screen edge the progress border runs along.",
    "themes.progress_bar.thickness_px": "Height of the border in pixels.",
    "themes.progress_bar.color": "A CSS color (e.g. #ff8800) for the filled portion.",
    "themes.artist_spotlight.corner": "Where the artist card appears on screen.",
    "themes.artist_spotlight.size_vw": "Max width as a percentage of screen width.",
    "themes.artist_spotlight.show_bio": "Show a short bio snippet below the artist name.",
    "themes.cast_mosaic.corner": "Where the cast grid appears on screen.",
    "themes.cast_mosaic.size_vw": "Max width as a percentage of screen width.",
