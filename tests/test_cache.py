...
def test_get_path_merges_artwork_headers_over_defaults(mock_get, tmp_path):
    ...
    cache = ImageCache(tmp_path)
    cache.get_path(Artwork(url="http://example.com/art.jpg", headers={"Referer": "https://example.com/"}))
...
def test_download_temp_merges_artwork_headers_over_defaults(mock_get, tmp_path):
    ...
    cache = ImageCache(tmp_path)
    cache.download_temp(Artwork(url="http://example.com/art.jpg", headers={"Referer": "https://example.com/"}))
